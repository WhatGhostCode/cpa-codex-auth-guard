# Build the codex-auth-guard plugin into a Windows .dll.
#
# Requirements:
#   - Go 1.21+
...
#    name without the extension: "codex-auth-guard".)

$ErrorActionPreference = "Stop"

$out = "codex-auth-guard.dll"
Write-Host "Building $out (CGO c-shared)..."
$env:CGO_ENABLED = "1"
go build -buildvcs=false -buildmode=c-shared -o $out .
